      ...
      <el-row>
         <el-col :span="12" class="border1px">
            ...
            <el-row>
               ...
               <el-input-number v-model="inputNum" size="small" :step="3" :min="-10" :max="10" :controls="false"
                                :disabled="true"></el-input-number>
               <el-input-number v-model="inputNum" size="small" :step="3" :min="-10" :max="10"
                                :controls="false"></el-input-number>
               <el-input-number v-model="inputNum" size="small" :step="3" :min="-10" :max="10" :controls="false"
                                :debounce="3000"></el-input-number>
            </el-row>
